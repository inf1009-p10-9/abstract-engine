...
/**
   A self-contained marketplace which manages an internal list of offers which
...
public abstract class StaticMarketplace implements IMarketplace {
    ...
    */
    ...
    /**
       @see IMarketplace#redeemOffer(IWalletBagImmutableOwnership, IOfferRequest)
     */
    @Override
