...
public class MovementManager {
    ...
    public void initialize() {
        ...
        movable = EntityManager.getInstance();
    }
    ...
    public void move(Entity object, int moveCount) {
        ...
        if (strategy != null && movable != null) {
            strategy.calculateMovement(object, moveCount, movable);
        }
    }
