...
import io.github.inf1009_p10_9.interfaces.IMovable;
...
public class UserMovement implements IMovementStrategy {
    ...
    @Override
    public void calculateMovement(Entity object, int moveCount, IMovable movable) {
        if (object == null || movable == null) {
            return;
        }
        ...
        // Apply the movement through IMovable
        movable.moveEntity(object, newPos);
    }
